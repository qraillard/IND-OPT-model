...
for sector in [
    ...
    Parameters_data= pd.read_excel("Input data/"+sector+"_data.xlsx",sheet_name=["TECHNOLOGIES","RESOURCES","TECHNOLOGIES_RESOURCES","TECHNOLOGIES_TECH_TYPE","SECTOR","CCS"])
    ...
    if counter>0:
        ...
        with open('Results/Result files/'+sector+'_results.pickle', 'wb') as f:
